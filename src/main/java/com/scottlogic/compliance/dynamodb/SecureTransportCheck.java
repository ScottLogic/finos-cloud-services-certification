...
import com.scottlogic.compliance.InvokingEvent;
...
public class SecureTransportCheck extends AbstractChecker {
    ...
    public static void main(String[] args) {
        ...
        String arn = "arn:aws:iam::032044580362:user/dynamo_test";
        // just a test event for local testing.
        ConfigEvent testEvent = new ConfigEvent()
                .withInvokingEvent("{\"configurationItem\": {" +
                        "\"configuration\": {" +
    ...
    public ComplianceType getComplianceCheck(InvokingEvent invokingEvent) {
            ...
            ComplianceType complianceResult = requiresSecureTransport ? ComplianceType.COMPLIANT : ComplianceType.NON_COMPLIANT;
